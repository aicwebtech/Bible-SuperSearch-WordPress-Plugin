...
<div class="inside bss-docs">
    <table class="form-table">
        ...
        <tr><td colspan='2'>
            <table class='shortcode-options-table bss'>
                ...
                <?php foreach(\BibleSuperSearch\WordPress\Shortcodes::getDisplayAttributes() as $key => $info): ?>
                    <tr>
                        <td style='' class='key'><?php echo $key;?></td>
                        <td style='vertical-align:top' class='name'><?php echo $info['name']; ?></td>
                        <td class='desc'><div><?php echo $info['desc']; ?></div></td>
                    </tr>
                <?php endforeach;?>
            </table>            
            <table class='shortcode-options-table downloads'>
                ...
                <?php foreach(\BibleSuperSearch\WordPress\Shortcodes::$downloadAttributes as $key => $info): ?>
                    <tr>
            ...
            <table class='shortcode-options-table bibles'>
                ...
                <?php foreach(\BibleSuperSearch\WordPress\Shortcodes::$biblesAttributes as $key => $info): ?>
                    <tr>
                        <td style='vertical-align:top' class='key'><?php echo $key;?></td>
                        <td style='vertical-align:top' class='name'><?php echo $info['name']; ?></td>
                        <td class='desc'><?php echo $info['desc']; ?></td>
