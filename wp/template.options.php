...
<!--             <div class="inner-sidebar">
                ...
                <div class="postbox sm-box">
                    ...
                    <div class="inside">
                        <p style="text-align:justify"><?php echo wp_sprintf( esc_html__( 'Did you know you can get expert support for only $49 per year! %s today and get support from the developers who are building the Bible SuperSearch.', 'biblesupersearch' ), '<a href="https://wpforchurch.com/wordpress-plugins/sermon-manager/?utm_source=sermon-manager&utm_medium=wordpress" target="_blank">' . esc_html__( 'Sign up', 'biblesupersearch' ) . '</a>' ); ?></p>
                ...
                <div class="postbox sm-box">
                    ...
                    <div class="inside">
                        <ul>
                            <li>- <a
                                        href="https://www.wpforchurch.com/my/knowledgebase/72/Getting-Started-with-biblesupersearch.html"
                        ...
                        <div style="text-align:center;font-size:0.85em;padding:0.4rem 0 0">
                            <span><?php echo wp_sprintf( esc_html__( 'Find out more in our %s', 'biblesupersearch' ), '<a href="https://www.wpforchurch.com/my/knowledgebase.php" title="Knowledgebase" target="_blank">' . esc_html__( 'knowledge base', 'biblesupersearch' ) . '</a>' ); ?></span>
                        </div>
                    </div>
                </div>
